...
pub(crate) struct MetadataAlgorithmMetrics {
    ...
    pub(crate) content_processed_left_atoms: u64,
    pub(crate) content_estimated_posting_visits: u64,
    pub(crate) content_visited_posting_entries: u64,
    pub(crate) content_token_exclusion_posting_visits: u64,
    pub(crate) content_dense_candidate_promotions: u64,
    pub(crate) content_raw_candidate_pairs: u64,
    pub(crate) content_dimension_rejected_pairs: u64,
    pub(crate) content_token_overlap_rejected_pairs: u64,
    ...
    pub(crate) exact_rescue_left_atoms: u64,
    pub(crate) exact_rescue_estimated_posting_visits: u64,
    pub(crate) unrescued_recall_risk_strata: u64,
    pub(crate) recall_risk_exceeded_groups: u64,
    ...
    pub(crate) recall_weighted_exact_matched_pairs: u128,
    pub(crate) recall_weighted_missed_matched_pairs: u128,
    pub(crate) recall_weighted_exact_duplicate_contract_members: u128,
    pub(crate) recall_weighted_missed_duplicate_contract_members: u128,
    pub(crate) recall_weighted_exact_component_members: u128,
    pub(crate) recall_weighted_shifted_component_members: u128,
