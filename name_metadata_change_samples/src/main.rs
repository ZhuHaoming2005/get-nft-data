...
fn progress_message(stage: SampleProgressStage, candidate_count: Option<usize>) -> String {
    let label = match stage {
        ...
        SampleProgressStage::BuildMetadataSeedDoc => "build metadata seed doc",
        SampleProgressStage::BuildMetadataSeedSketch => "build metadata seed sketch",
        SampleProgressStage::CollectMetadataSourceBuckets => "collect metadata source buckets",
        SampleProgressStage::VerifyMetadataSourceBuckets => "verify metadata source buckets",
        SampleProgressStage::CollectMetadataCandidates => "collect metadata sources",
        SampleProgressStage::ScoreMetadataPrefilter => "score metadata prefilter sources",
